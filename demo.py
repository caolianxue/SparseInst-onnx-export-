...
# python demo.py --config-file configs/sparse_inst_r50vd_dcn_giam_aug.yaml --input datasets/coco-608-608-val/images/* --output results --opt MODEL.WEIGHTS ./output/sparse_inst_r50vd_dcn_giam_aug/model_final.pth INPUT.MIN_SIZE_TEST 608
...
if __name__ == "__main__":
    ...
    args.input = ['datasets/coco-608-608-val/images/*']
    args.output = 'results'
    args.opts = ['MODEL.WEIGHTS', './output/sparse_inst_r50_giam/model_0009999.pth', 'INPUT.MIN_SIZE_TEST', '608']
